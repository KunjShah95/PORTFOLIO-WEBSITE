      ...
      <div className="container-aligned space-y-24 relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between border-b border-border pb-10 gap-8 bg-surface/80 backdrop-blur-sm">
          <div className="space-y-4">
            ...
            <h2 className="text-6xl font-black tracking-tighter text-txt uppercase italic">EXPERIENCE <span className="text-secondary opacity-60 not-italic">TIMELINE</span></h2>
          </div>
        ...
        <div className="space-y-12">
          {experiences.map((exp, i) => (
            ...
            >
              ...
              <div className="group grid lg:grid-cols-12 gap-12 p-12 lg:p-16 border border-border bg-surface/20 hover:border-primary/30 transition-all duration-700 relative overflow-hidden border-glow items-center">
                ...
                <div className="lg:col-span-6 space-y-6">
                   <div className="space-y-2">
                      <h3 className="text-4xl font-black text-txt uppercase tracking-tighter leading-none group-hover:text-primary transition-colors duration-500 italic">{exp.company}</h3>
                ...
                <div className="lg:col-span-3 flex flex-col items-end gap-12">
                   <div className="flex flex-wrap gap-2.5 justify-end">
                      {exp.skills.map(skill => (
                        <span key={skill} className="px-4 py-1.5 text-[9px] font-black font-mono border border-border bg-surface/5 text-muted group-hover:text-primary group-hover:border-primary/20 uppercase tracking-widest transition-all italic">
                           {skill}
                        </span>
                      ))}
                   </div>
                   <div className="flex justify-end gap-8 text-txt/5 group-hover:text-primary/10 transition-colors">
