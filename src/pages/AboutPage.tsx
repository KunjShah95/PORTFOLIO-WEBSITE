      ...
      <section className="space-y-16">
        <div className="flex items-end justify-between border-b border-white/5 pb-8">
          <div className="space-y-3">
            ...
            <h2 className="text-5xl font-bold tracking-tighter text-white uppercase">Architect_Persona</h2>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
          <div className="lg:col-span-8 space-y-12">
            <motion.div 
               ...
               className="space-y-8"
            >
               <h3 className="text-3xl font-bold text-white tracking-tight leading-tight uppercase max-w-2xl group">
                  Engineering the bridge between <span className="text-accent underline underline-offset-8 decoration-1">human intent</span> and <span className="text-white bg-white/5 px-3 py-1">machine execution</span>.
               </h3>
               ...
               <div className="pt-8 grid sm:grid-cols-2 gap-8">
                  <div className="p-8 border border-white/5 bg-surface/30 relative group overflow-hidden">
                     <div className="absolute top-0 right-0 w-8 h-8 opacity-5 group-hover:opacity-10 transition-opacity">
                        <Activity className="w-full h-full text-white" />
                     </div>
                     <h4 className="text-[10px] font-bold text-white tracking-[0.2em] uppercase mb-4 flex items-center gap-2">
          ...
          <div className="lg:col-span-4 space-y-12">
             <div className="aspect-[4/5] bg-surface/50 border border-white/5 relative overflow-hidden group">
                {/* Placeholder for an actual image or a generated asset */}
                <div className="absolute inset-0 flex items-center justify-center">
                   <Shield className="w-24 h-24 text-white/5 group-hover:text-accent/10 transition-colors duration-700" />
                </div>
                <div className="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-black to-transparent">
                   ...
                   <div className="text-xl font-bold text-white uppercase tracking-tighter">SEC_IDENTITY_01</div>
                </div>
             ...
             <div className="space-y-4">
                <div className="text-[9px] font-mono text-muted uppercase tracking-widest border-b border-white/5 pb-2 font-bold">Protocol_Access</div>
                <div className="flex flex-col gap-2">
                   ...
                   <div className="flex justify-between items-center py-1">
                      ...
                      <span className="text-[10px] font-mono text-white">AHMEDABAD_INDIA</span>
                   </div>
                   <div className="flex justify-between items-center py-1">
                      <span className="text-[10px] font-mono text-muted">Time_Zone</span>
                      <span className="text-[10px] font-mono text-white">GMT+5:30</span>
                   </div>
                </div>
             </div>
          </div>
